...
def generate_launch_description():
    ...
    default_model_path = urdf_tutorial_path / 'urdf/doble_robot.urdf'   # dos modelos de los 2 dedos
    #default_model_path = urdf_tutorial_path / 'urdf/pulgar.urdf'   # urdf del pulgar
    #default_model_path = urdf_tutorial_path / 'urdf/indice.urdf'   # urdf del indice
